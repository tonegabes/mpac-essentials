<?php
// source: phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar/conf/config.neon
// source: phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar/conf/config.level10.neon
// source: E:\codes\mpac-essentials\phpstan.neon
// source: array
...
class Container_8c050fb21e extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.typeSpecifier.methodTypeSpecifyingExtension' => ['0250' => true, '0988' => true],
		...
		'phpstan.restrictedClassConstantUsageExtension' => ['0829' => true],
		'phpstan.restrictedClassNameUsageExtension' => ['0830' => true],
		'phpstan.restrictedFunctionUsageExtension' => ['0831' => true],
		'phpstan.restrictedPropertyUsageExtension' => ['0833' => true],
		'phpstan.restrictedMethodUsageExtension' => ['0834' => true],
		...
		'phpstan.functionParameterClosureThisExtension' => ['0974' => true],
		'phpstan.broker.expressionTypeResolverExtension' => ['0978' => true, '0979' => true],
		'phpstan.ignoreErrorExtension' => ['0980' => true, '0982' => true, '0999' => true, '01000' => true],
		'phpstan.typeSpecifier.staticMethodTypeSpecifyingExtension' => ['0989' => true],
	];
	...
	protected $wiring = [
		...
		'PestStan\Rules\DisallowedCallInDescribeRule' => [['rules.4']],
		'PestStan\Rules\StaticTestClosureRule' => [['rules.5']],
		'PestStan\Rules\RepeatWithInvalidValueRule' => [['rules.6']],
		'PestStan\Rules\DuplicateTestDescriptionRule' => [['rules.7']],
		'PestStan\Rules\ImpossibleExpectationRule' => [['rules.8']],
		'PestStan\Rules\RedundantExpectationRule' => [['rules.9']],
		'PestStan\Rules\ExpectationValueTypeRule' => [['rules.10']],
		'PestStan\Rules\EmptyTestClosureRule' => [['rules.11']],
		'PestStan\Rules\BeforeAllThisUsageRule' => [['rules.12']],
		'PestStan\Rules\DescribeWithoutTestsRule' => [['rules.13']],
		'PestStan\Rules\InvalidGroupNameRule' => [['rules.14']],
		'PestStan\Rules\RedundantLocalUseRule' => [['rules.15']],
		'PHPStan\Rules\PHPUnit\AssertSameBooleanExpectedRule' => [['rules.16']],
		'PHPStan\Rules\PHPUnit\AssertSameNullExpectedRule' => [['rules.17']],
		'PHPStan\Rules\PHPUnit\AssertSameWithCountRule' => [['rules.18']],
		'PHPStan\Rules\PHPUnit\ClassCoversExistsRule' => [['rules.19']],
		'PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule' => [['rules.20']],
		'PHPStan\Rules\PHPUnit\MockMethodCallRule' => [['rules.21']],
		'PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule' => [['rules.22']],
		'PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule' => [['rules.23']],
		'PHPStan\Rules\PHPUnit\ShouldCallParentMethodsRule' => [['rules.24']],
		...
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [
			['0178', '0802', '0803', '0805', '0858', '0859', '0860', '0866', '0975', '0976'],
		],
		...
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [['0250', '0988']],
		...
		'PHPStan\PhpDoc\TypeNodeResolverExtension' => [['0902', '0903', '0911', '0915', '0916', '0986']],
		...
		'PHPStan\PhpDoc\TypeNodeResolverAwareExtension' => [['0916', '0986']],
		...
		'PestStan\Type\Pest\PestFileDiscoverer' => [['0969']],
		'PestStan\Type\Pest\PestConfigReader' => [['0970']],
		'PestStan\Type\Pest\PestFunctionReturnTypeExtension' => [['0971']],
		'PestStan\Type\Pest\ExpectationMethodReturnTypeExtension' => [['0972']],
		'PestStan\Type\Pest\OppositeExpectationMethodReturnTypeExtension' => [['0973']],
		'PHPStan\Type\FunctionParameterClosureThisExtension' => [['0974']],
		'PestStan\Type\Pest\TestClosureThisTypeExtension' => [['0974']],
		'PestStan\Type\Pest\TestCasePropertiesExtension' => [['0975']],
		'PestStan\Type\Pest\ExpectationPropertiesExtension' => [['0976']],
		'PestStan\Type\Pest\PestHookPropertyReader' => [['0977']],
		'PHPStan\Type\ExpressionTypeResolverExtension' => [['0978', '0979']],
		'PestStan\Type\Pest\TestCaseDynamicPropertyTypeExtension' => [['0978']],
		'PestStan\Type\Pest\HigherOrderExpectationTypeExtension' => [['0979']],
		'PHPStan\Analyser\IgnoreErrorExtension' => [['0980', '0982', '0999', '01000']],
		'PestStan\Type\Pest\PestInternalClassAccessIgnoreExtension' => [['0980']],
		'PestStan\Type\Pest\TestCallMethodsClassReflectionExtension' => [['0981']],
		'PestStan\Type\Pest\ProtectedMethodCallIgnoreExtension' => [['0982']],
		'PestStan\Rules\InvalidThrowsExceptionRule' => [['0983']],
		'PestStan\Rules\CoversClassExistsRule' => [['0984']],
		'Carbon\PHPStan\MacroExtension' => [['0985']],
		'PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension' => [['0986']],
		'PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension' => [['0987']],
		'PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension' => [['0988']],
		'PHPStan\Type\StaticMethodTypeSpecifyingExtension' => [['0989']],
		'PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension' => [['0989']],
		'PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension' => [['0990']],
		'PHPStan\Type\PHPUnit\MockForIntersectionDynamicReturnTypeExtension' => [['0991']],
		'PHPStan\Rules\PHPUnit\CoversHelper' => [['0992']],
		'PHPStan\Rules\PHPUnit\AnnotationHelper' => [['0993']],
		'PHPStan\Rules\PHPUnit\TestMethodsHelper' => [['0994']],
		'PHPStan\Rules\PHPUnit\PHPUnitVersion' => [['0995']],
		'PHPStan\Rules\PHPUnit\PHPUnitVersionDetector' => [['0996']],
		'PHPStan\Rules\PHPUnit\DataProviderHelper' => [['0997']],
		'PHPStan\Rules\PHPUnit\DataProviderHelperFactory' => [['0998']],
		'PHPStan\Type\PHPUnit\DataProviderReturnTypeIgnoreExtension' => [['0999']],
		'PHPStan\Type\PHPUnit\DynamicCallToAssertionIgnoreExtension' => [['01000']],
		'PHPStan\Rules\PHPUnit\AttributeVersionRequirementHelper' => [['01001']],
		'PHPStan\Rules\PHPUnit\DataProviderDeclarationRule' => [['01002']],
		'PHPStan\Rules\PHPUnit\AttributeRequiresPhpVersionRule' => [['01003']],
		'PHPStan\Rules\PHPUnit\ClassAttributeRequiresPhpVersionRule' => [['01004']],
		'PHPStan\Rules\PHPUnit\AssertEqualsIsDiscouragedRule' => [['01005']],
		'PHPStan\Rules\PHPUnit\DataProviderDataRule' => [['01006']],
	];
	...
	public function createService02(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			'E:\codes\mpac-essentials',
			($this->getParameter('sysGetTempDir')) . '/phpstan-fixer',
			['E:/codes/mpac-essentials'],
			[
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\conf\parametersSchema.neon',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\conf\config.level10.neon',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\conf\config.level9.neon',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\conf\config.level8.neon',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\conf\config.level7.neon',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\conf\config.level6.neon',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\conf\config.level5.neon',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\conf\config.level4.neon',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\conf\config.level3.neon',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\conf\config.level2.neon',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\conf\config.level1.neon',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\conf\config.level0.neon',
				'E:\codes\mpac-essentials\phpstan.neon',
				'E:\codes\mpac-essentials\vendor\larastan\larastan\extension.neon',
				'E:\codes\mpac-essentials\vendor\mrpunyapal\peststan\extension.neon',
				'E:\codes\mpac-essentials\vendor\nesbot\carbon\extension.neon',
				'E:\codes\mpac-essentials\vendor\phpstan\phpstan-phpunit\extension.neon',
				'E:\codes\mpac-essentials\vendor\phpstan\phpstan-phpunit\rules.neon',
				'phar://phpstan.phar\conf\bleedingEdge.neon',
			],
			null,
			[
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionUnionType.php',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionAttribute.php',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\Attribute85.php',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionIntersectionType.php',
				'E:\codes\mpac-essentials\vendor\larastan\larastan\bootstrap.php',
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, ['E:/codes/mpac-essentials']);
	}
	...
	{
		return new PHPStan\Php\ComposerPhpVersionFactory(['E:/codes/mpac-essentials']);
	}
	...
	{
		return new PHPStan\Reflection\ConstructorsHelper($this->getService('0125'), ['PHPUnit\Framework\TestCase::setUp']);
	}
	...
	public function createService030(): PHPStan\Reflection\BetterReflection\BetterReflectionSourceLocatorFactory
	{
		return new PHPStan\Reflection\BetterReflection\BetterReflectionSourceLocatorFactory(
			...
			$this->getService('037'),
			[],
			['E:\codes\mpac-essentials\vendor\mrpunyapal\peststan\src'],
			$this->getParameter('analysedPaths'),
			['E:/codes/mpac-essentials'],
	...
	{
		return new PHPStan\File\FileHelper('E:\codes\mpac-essentials');
	}
	...
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideTypeCheck($this->getService('060'), true, false);
	}
	...
	public function createService0126(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'E:\codes\mpac-essentials',
			'E:\codes\mpac-essentials\tmp\phpstan',
			[
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar/conf/config.level10.neon',
				'E:\codes\mpac-essentials\phpstan.neon',
			],
	...
	public function createService0145(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			...
			$this->getService('041'),
			[
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\Memcached.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\Redis.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionAttribute.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionClassConstant.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionFunctionAbstract.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionMethod.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionParameter.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionProperty.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\iterable.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\ArrayObject.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\WeakReference.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\ext-ds.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\ImagickPixel.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\PDOStatement.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\date.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\ibm_db2.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\mysqli.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\zip.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\dom.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\spl.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\SplObjectStorage.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\Exception.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\arrayFunctions.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\core.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\typeCheckingFunctions.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\Countable.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\file.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\stream_socket_client.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\stream_socket_server.stub',
				'phar://E:\codes\mpac-essentials\vendor\phpstan\phpstan\phpstan.phar\stubs\ctype.stub',
				'E:\codes\mpac-essentials\vendor\phpstan\phpstan-phpunit\stubs\Assert.stub',
				'E:\codes\mpac-essentials\vendor\phpstan\phpstan-phpunit\stubs\AssertionFailedError.stub',
				'E:\codes\mpac-essentials\vendor\phpstan\phpstan-phpunit\stubs\ExpectationFailedException.stub',
				'E:\codes\mpac-essentials\vendor\phpstan\phpstan-phpunit\stubs\MockBuilder.stub',
				'E:\codes\mpac-essentials\vendor\phpstan\phpstan-phpunit\stubs\MockObject.stub',
				'E:\codes\mpac-essentials\vendor\phpstan\phpstan-phpunit\stubs\Stub.stub',
				'E:\codes\mpac-essentials\vendor\phpstan\phpstan-phpunit\stubs\TestCase.stub',
			],
			['E:/codes/mpac-essentials']
		);
	}
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('E:\codes\mpac-essentials\tmp\phpstan/resultCache.php');
	}
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_8c050fb21e $container)
			{
		...
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'E:\codes\mpac-essentials\tmp\phpstan/resultCache.php',
	...
	{
		return new PHPStan\Rules\Operators\InvalidComparisonOperationRule($this->getService('046'), $this->getService('0133'), true);
	}
	...
	{
		return new PHPStan\Rules\Keywords\RequireFileExistsRule('E:\codes\mpac-essentials', $this->getService('06'), true);
	}
	...
	{
		return new PHPStan\Rules\Constants\ValueAssignedToClassConstantRule($this->getService('0449'), true);
	}
	...
	{
		return new PHPStan\Dependency\PackageDependencyResolver(['E:/codes/mpac-essentials'], $this->getService('041'));
	}
	...
	public function createService0803(): PHPStan\Reflection\Php\UniversalObjectCratesClassReflectionExtension
	{
		return new PHPStan\Reflection\Php\UniversalObjectCratesClassReflectionExtension(
			$this->getService('reflectionProvider'),
			['stdClass', 'Illuminate\Http\Request', 'Illuminate\Support\Optional', 'PHPUnit\Framework\TestCase'],
			$this->getService('0802')
		);
	}
	...
	{
		return new PHPStan\Rules\Methods\MethodSignatureRule($this->getService('0117'), false, false, true);
	}
	...
	{
		return new Larastan\Larastan\Properties\MigrationCache('E:\codes\mpac-essentials\tmp\phpstan', false);
	}
	...
	public function createService0969(): PestStan\Type\Pest\PestFileDiscoverer
	{
		return new PestStan\Type\Pest\PestFileDiscoverer(
			[
				'E:\codes\mpac-essentials\app',
				'E:\codes\mpac-essentials\bootstrap',
				'E:\codes\mpac-essentials\config',
				'E:\codes\mpac-essentials\database',
				'E:\codes\mpac-essentials\resources\views',
				'E:\codes\mpac-essentials\public',
				'E:\codes\mpac-essentials\routes',
				'E:\codes\mpac-essentials\tests',
			],
			'E:\codes\mpac-essentials'
		);
	}
	...
	public function createService0970(): PestStan\Type\Pest\PestConfigReader
	{
		return new PestStan\Type\Pest\PestConfigReader(['tests/Pest.php'], $this->getService('0969'));
	}


	public function createService0971(): PestStan\Type\Pest\PestFunctionReturnTypeExtension
	{
		return new PestStan\Type\Pest\PestFunctionReturnTypeExtension;
	}


	public function createService0972(): PestStan\Type\Pest\ExpectationMethodReturnTypeExtension
	{
		return new PestStan\Type\Pest\ExpectationMethodReturnTypeExtension;
	}


	public function createService0973(): PestStan\Type\Pest\OppositeExpectationMethodReturnTypeExtension
	{
		return new PestStan\Type\Pest\OppositeExpectationMethodReturnTypeExtension;
	}


	public function createService0974(): PestStan\Type\Pest\TestClosureThisTypeExtension
	{
		return new PestStan\Type\Pest\TestClosureThisTypeExtension($this->getService('0970'), 'Tests\TestCase');
	}


	public function createService0975(): PestStan\Type\Pest\TestCasePropertiesExtension
	{
		return new PestStan\Type\Pest\TestCasePropertiesExtension;
	}


	public function createService0976(): PestStan\Type\Pest\ExpectationPropertiesExtension
	{
		return new PestStan\Type\Pest\ExpectationPropertiesExtension;
	}


	public function createService0977(): PestStan\Type\Pest\PestHookPropertyReader
	{
		return new PestStan\Type\Pest\PestHookPropertyReader($this->getService('0969'));
	}


	public function createService0978(): PestStan\Type\Pest\TestCaseDynamicPropertyTypeExtension
	{
		return new PestStan\Type\Pest\TestCaseDynamicPropertyTypeExtension($this->getService('0977'));
	}


	public function createService0979(): PestStan\Type\Pest\HigherOrderExpectationTypeExtension
	{
		return new PestStan\Type\Pest\HigherOrderExpectationTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0980(): PestStan\Type\Pest\PestInternalClassAccessIgnoreExtension
	{
		return new PestStan\Type\Pest\PestInternalClassAccessIgnoreExtension;
	}


	public function createService0981(): PestStan\Type\Pest\TestCallMethodsClassReflectionExtension
	{
		return new PestStan\Type\Pest\TestCallMethodsClassReflectionExtension($this->getService('reflectionProvider'), 'Tests\TestCase');
	}


	public function createService0982(): PestStan\Type\Pest\ProtectedMethodCallIgnoreExtension
	{
		return new PestStan\Type\Pest\ProtectedMethodCallIgnoreExtension('Tests\TestCase');
	}


	public function createService0983(): PestStan\Rules\InvalidThrowsExceptionRule
	{
		return new PestStan\Rules\InvalidThrowsExceptionRule($this->getService('reflectionProvider'));
	}


	public function createService0984(): PestStan\Rules\CoversClassExistsRule
	{
		return new PestStan\Rules\CoversClassExistsRule($this->getService('reflectionProvider'));
	}


	public function createService0985(): Carbon\PHPStan\MacroExtension
	{
		return new Carbon\PHPStan\MacroExtension($this->getService('reflectionProvider'), $this->getService('0339'));
	}


	public function createService0986(): PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension
	{
		return new PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension;
	}


	public function createService0987(): PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension;
	}


	public function createService0988(): PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension;
	}


	public function createService0989(): PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension;
	}


	public function createService0990(): PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension;
	}


	public function createService0991(): PHPStan\Type\PHPUnit\MockForIntersectionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\MockForIntersectionDynamicReturnTypeExtension;
	}


	public function createService0992(): PHPStan\Rules\PHPUnit\CoversHelper
	{
		return new PHPStan\Rules\PHPUnit\CoversHelper($this->getService('reflectionProvider'));
	}


	public function createService0993(): PHPStan\Rules\PHPUnit\AnnotationHelper
	{
		return new PHPStan\Rules\PHPUnit\AnnotationHelper;
	}


	public function createService0994(): PHPStan\Rules\PHPUnit\TestMethodsHelper
	{
		return new PHPStan\Rules\PHPUnit\TestMethodsHelper($this->getService('0332'), $this->getService('0995'));
	}


	public function createService0995(): PHPStan\Rules\PHPUnit\PHPUnitVersion
	{
		return $this->getService('0996')->createPHPUnitVersion();
	}


	public function createService0996(): PHPStan\Rules\PHPUnit\PHPUnitVersionDetector
	{
		return new PHPStan\Rules\PHPUnit\PHPUnitVersionDetector;
	}


	public function createService0997(): PHPStan\Rules\PHPUnit\DataProviderHelper
	{
		return $this->getService('0998')->create();
	}


	public function createService0998(): PHPStan\Rules\PHPUnit\DataProviderHelperFactory
	{
	...
	public function createService0999(): PHPStan\Type\PHPUnit\DataProviderReturnTypeIgnoreExtension
	{
		return new PHPStan\Type\PHPUnit\DataProviderReturnTypeIgnoreExtension($this->getService('0994'), $this->getService('0997'));
	}


	public function createService01000(): PHPStan\Type\PHPUnit\DynamicCallToAssertionIgnoreExtension
	{
		return new PHPStan\Type\PHPUnit\DynamicCallToAssertionIgnoreExtension;
	}


	public function createService01001(): PHPStan\Rules\PHPUnit\AttributeVersionRequirementHelper
	{
	...
	public function createService01002(): PHPStan\Rules\PHPUnit\DataProviderDeclarationRule
	{
		return new PHPStan\Rules\PHPUnit\DataProviderDeclarationRule($this->getService('0997'), false, false);
	}


	public function createService01003(): PHPStan\Rules\PHPUnit\AttributeRequiresPhpVersionRule
	{
		return new PHPStan\Rules\PHPUnit\AttributeRequiresPhpVersionRule($this->getService('0994'), $this->getService('01001'));
	}


	public function createService01004(): PHPStan\Rules\PHPUnit\ClassAttributeRequiresPhpVersionRule
	{
		return new PHPStan\Rules\PHPUnit\ClassAttributeRequiresPhpVersionRule($this->getService('01001'));
	}


	public function createService01005(): PHPStan\Rules\PHPUnit\AssertEqualsIsDiscouragedRule
	{
		return new PHPStan\Rules\PHPUnit\AssertEqualsIsDiscouragedRule;
	}


	public function createService01006(): PHPStan\Rules\PHPUnit\DataProviderDataRule
	{
	...
	{
		return new PHPStan\Cache\FileCacheStorage('E:\codes\mpac-essentials\tmp\phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_8c050fb21e
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('E:\codes\mpac-essentials');
	}
	...
	public function createServiceRules__10(): PestStan\Rules\ExpectationValueTypeRule
	{
		return new PestStan\Rules\ExpectationValueTypeRule;
	}


	public function createServiceRules__11(): PestStan\Rules\EmptyTestClosureRule
	{
		return new PestStan\Rules\EmptyTestClosureRule;
	}


	public function createServiceRules__12(): PestStan\Rules\BeforeAllThisUsageRule
	{
		return new PestStan\Rules\BeforeAllThisUsageRule;
	}


	public function createServiceRules__13(): PestStan\Rules\DescribeWithoutTestsRule
	{
		return new PestStan\Rules\DescribeWithoutTestsRule;
	}


	public function createServiceRules__14(): PestStan\Rules\InvalidGroupNameRule
	{
		return new PestStan\Rules\InvalidGroupNameRule;
	}


	public function createServiceRules__15(): PestStan\Rules\RedundantLocalUseRule
	{
		return new PestStan\Rules\RedundantLocalUseRule($this->getService('0970'));
	}


	public function createServiceRules__16(): PHPStan\Rules\PHPUnit\AssertSameBooleanExpectedRule
	{
		return new PHPStan\Rules\PHPUnit\AssertSameBooleanExpectedRule;
	}


	public function createServiceRules__17(): PHPStan\Rules\PHPUnit\AssertSameNullExpectedRule
	{
		return new PHPStan\Rules\PHPUnit\AssertSameNullExpectedRule;
	}


	public function createServiceRules__18(): PHPStan\Rules\PHPUnit\AssertSameWithCountRule
	{
		return new PHPStan\Rules\PHPUnit\AssertSameWithCountRule;
	}


	public function createServiceRules__19(): PHPStan\Rules\PHPUnit\ClassCoversExistsRule
	{
		return new PHPStan\Rules\PHPUnit\ClassCoversExistsRule($this->getService('0992'), $this->getService('reflectionProvider'));
	}
	...
	public function createServiceRules__20(): PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule
	{
		return new PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule($this->getService('0992'), $this->getService('0332'));
	}


	public function createServiceRules__21(): PHPStan\Rules\PHPUnit\MockMethodCallRule
	{
		return new PHPStan\Rules\PHPUnit\MockMethodCallRule;
	}


	public function createServiceRules__22(): PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule
	{
		return new PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule($this->getService('0993'));
	}


	public function createServiceRules__23(): PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule
	{
		return new PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule($this->getService('0993'));
	}


	public function createServiceRules__24(): PHPStan\Rules\PHPUnit\ShouldCallParentMethodsRule
	{
	...
	public function createServiceRules__4(): PestStan\Rules\DisallowedCallInDescribeRule
	{
		return new PestStan\Rules\DisallowedCallInDescribeRule;
	}


	public function createServiceRules__5(): PestStan\Rules\StaticTestClosureRule
	{
		return new PestStan\Rules\StaticTestClosureRule;
	}


	public function createServiceRules__6(): PestStan\Rules\RepeatWithInvalidValueRule
	{
		return new PestStan\Rules\RepeatWithInvalidValueRule;
	}


	public function createServiceRules__7(): PestStan\Rules\DuplicateTestDescriptionRule
	{
		return new PestStan\Rules\DuplicateTestDescriptionRule;
	}


	public function createServiceRules__8(): PestStan\Rules\ImpossibleExpectationRule
	{
		return new PestStan\Rules\ImpossibleExpectationRule;
	}


	public function createServiceRules__9(): PestStan\Rules\RedundantExpectationRule
	{
		return new PestStan\Rules\RedundantExpectationRule;
	}


	public function createServiceSimpleRelativePathHelper(): PHPStan\File\SimpleRelativePathHelper
	{
		return new PHPStan\File\SimpleRelativePathHelper('E:\codes\mpac-essentials');
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'scanFiles' => [],
			'scanDirectories' => ['E:\codes\mpac-essentials\vendor\mrpunyapal\peststan\src'],
			'parallel' => [
				'jobSize' => 20,
			...
			'resultCachePath' => 'E:\codes\mpac-essentials\tmp\phpstan/resultCache.php',
			...
			'peststan' => ['testCaseClass' => 'Tests\TestCase', 'pestConfigFiles' => ['tests/Pest.php']],
			'phpunit' => ['convertUnionToIntersectionType' => true, 'reportMissingDataProviderReturnType' => false],
			'tmpDir' => 'E:\codes\mpac-essentials\tmp\phpstan',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => 'E:\codes\mpac-essentials\tmp\phpstan',
			'rootDir' => 'E:\codes\mpac-essentials\vendor\phpstan\phpstan',
			'currentWorkingDirectory' => 'E:\codes\mpac-essentials',
			...
			'composerAutoloaderProjectPaths' => ['E:/codes/mpac-essentials'],
			'generateBaselineFile' => null,
			'usedLevel' => '10',
			'cliAutoloadFile' => null,
			'env' => [
				'BIN_TARGET' => 'E:\codes\mpac-essentials\vendor\bin\/phpstan',
				'COLUMNS' => '187',
				'COMPOSER_BINARY' => 'C:\ProgramData\ComposerSetup\bin\composer.phar',
				'COMPOSER_RUNTIME_BIN_DIR' => 'E:\codes\mpac-essentials\vendor\bin\\',
				'LINES' => '33',
				'SHELL_VERBOSITY' => '0',
				'GIT_TERMINAL_PROMPT' => '0',
				'LANGUAGE' => 'C',
				'COMPOSER_DEV_MODE' => '1',
				'PATH' => 'E:\codes\mpac-essentials\vendor\bin;C:\Program Files\WindowsApps\Microsoft.PowerShell_7.6.4.0_x64__8wekyb3d8bbwe;C:\Program Files (x86)\oh-my-posh\bin\;C:\Python312\Scripts\;C:\Python312\;C:\Python311\Scripts\;C:\Python311\;C:\Program Files (x86)\Common Files\Oracle\Java\javapath;C:\WINDOWS\system32;C:\WINDOWS;C:\WINDOWS\System32\Wbem;C:\WINDOWS\System32\WindowsPowerShell\v1.0\;C:\WINDOWS\System32\OpenSSH\;C:\Program Files\SafeNet\Authentication\SAC\x64;C:\Program Files\SafeNet\Authentication\SAC\x32;C:\ProgramData\chocolatey\bin;C:\ProgramData\ComposerSetup\bin;C:\flutter\flutter-3.7.7\bin;C:\Program Files (x86)\Microsoft SQL Server\160\DTS\Binn\;C:\instantclient_19_30;c:\Users\asouza\AppData\Local\Programs\cursor\resources\app\bin;C:\WINDOWS\system32;C:\WINDOWS;C:\WINDOWS\System32\Wbem;C:\WINDOWS\System32\WindowsPowerShell\v1.0\;C:\WINDOWS\System32\OpenSSH\;C:\Program Files\Git\cmd;C:\Program Files\nodejs\;C:\Program Files\Neovim\bin;C:\Program Files\cursor\resources\app\bin;E:\laragon\bin\php\php-8.4.20-nts-Win32-vs17-x64;C:\Program Files\WezTerm;E:\Programs\Godot;C:\Program Files (x86)\Nmap;;C:\Program Files\Docker\Docker\resources\bin;C:\Program Files\WindowsApps\Microsoft.PowerShell_7.6.1.0_x64__8wekyb3d8bbwe;C:\Program Files (x86)\oh-my-posh\bin\;C:\Python312\Scripts\;C:\Python312\;C:\Python311\Scripts\;C:\Python311\;C:\Program Files (x86)\Common Files\Oracle\Java\javapath;C:\WINDOWS\system32;C:\WINDOWS;C:\WINDOWS\System32\Wbem;C:\WINDOWS\System32\WindowsPowerShell\v1.0\;C:\WINDOWS\System32\OpenSSH\;C:\Program Files\SafeNet\Authentication\SAC\x64;C:\Program Files\SafeNet\Authentication\SAC\x32;C:\ProgramData\chocolatey\bin;C:\ProgramData\ComposerSetup\bin;C:\flutter\flutter-3.7.7\bin;C:\Program Files (x86)\Microsoft SQL Server\160\DTS\Binn\;C:\instantclient_19_30;c:\Users\asouza\AppData\Local\Programs\cursor\resources\app\bin;C:\WINDOWS\system32;C:\WINDOWS;C:\WINDOWS\System32\Wbem;C:\WINDOWS\System32\WindowsPowerShell\v1.0\;C:\WINDOWS\System32\OpenSSH\;C:\Program Files\Git\cmd;C:\Program Files\nodejs\;C:\Program Files\Neovim\bin;C:\Program Files\cursor\resources\app\bin;E:\laragon\bin\php\php-8.4.20-nts-Win32-vs17-x64;C:\Program Files\WezTerm;C:\Program Files\Docker\Docker\resources\bin;E:\Programs\Godot;C:\Users\asouza\AppData\Local\Yarn\config\global\node_modules\.bin;C:\Users\asouza\AppData\Roaming\Composer\vendor\bin;C:\Users\asouza\AppData\Roaming\npm;E:\laragon\bin\composer;E:\laragon\bin\git\bin;E:\laragon\bin\git\cmd;E:\laragon\bin\git\mingw64\bin;E:\laragon\bin\git\usr\bin;E:\laragon\bin\mysql\mysql-8.4.3-winx64\bin;E:\laragon\bin\ngrok;E:\laragon\bin\nodejs\node-v22;E:\laragon\bin\php\php-8.4.20-nts-Win32-vs17-x64;E:\laragon\bin\python\python-3.13;E:\laragon\bin\python\python-3.13\Scripts;E:\laragon\usr\bin;C:\Users\asouza\AppData\Local\pnpm;C:\Users\asouza\AppData\Local\Programs\Microsoft VS Code\bin;C:\Users\asouza\AppData\Local\Microsoft\WindowsApps;C:\Users\asouza\AppData\Local\Programs\Zed\bin;C:\Users\asouza\AppData\Local\Programs\Antigravity\bin;C:\Users\asouza\.bun\bin;C:\Users\asouza\AppData\Local\Programs\cursor\resources\app\bin;C:\Users\asouza\AppData\Local\Programs\Warp\bin;C:\Users\asouza\AppData\Local\Programs\Ollama;C:\Users\asouza\AppData\Local\cursor-agent;C:\Users\asouza\AppData\Local\GitHubDesktop\bin;E:\Programs\Godot;C:\Users\asouza\AppData\Local\Microsoft\WinGet\Packages\ajeetdsouza.zoxide_Microsoft.Winget.Source_8wekyb3d8bbwe;C:\Users\asouza\AppData\Local\Microsoft\WinGet\Packages\eza-community.eza_Microsoft.Winget.Source_8wekyb3d8bbwe;',
				'PHP_BINARY' => 'E:\laragon\bin\php\php-8.4.20-nts-Win32-vs17-x64\php.exe',
				'LOCALAPPDATA' => 'C:\Users\asouza\AppData\Local',
				...
				'POSH_SESSION_ID' => '39bf950d-426c-41a4-aacc-e0219bc52074',
				'ProgramW6432' => 'C:\Program Files',
				'PROMPT' => '$P$G',
				'TERM' => 'xterm-256color',
				'EFC_12656_3789132940' => '1',
				'TMP' => 'C:\Users\asouza\AppData\Local\Temp',
				'ADL_4KWORKAROUND_CANCEL' => 'TRUE',
				'ProgramData' => 'C:\ProgramData',
				'EFC_12656_2283032206' => '1',
				'WEZTERM_PANE' => '0',
				'SystemRoot' => 'C:\WINDOWS',
				'PSModulePath' => 'C:\Users\asouza\OneDrive - mpacre\Documentos\PowerShell\Modules;C:\Program Files\PowerShell\Modules;c:\program files\windowsapps\microsoft.powershell_7.6.4.0_x64__8wekyb3d8bbwe\Modules;C:\Program Files\WindowsPowerShell\Modules;C:\WINDOWS\system32\WindowsPowerShell\v1.0\Modules',
				'FPS_BROWSER_APP_PROFILE_STRING' => 'Internet Explorer',
				'PROCESSOR_IDENTIFIER' => 'Intel64 Family 6 Model 151 Stepping 2, GenuineIntel',
				'WEZTERM_UNIX_SOCKET' => 'C:\Users\asouza\.local/share/wezterm\gui-sock-19848',
				'EFC_12656_2775293581' => '1',
				...
				'COMPUTERNAME' => 'DIRTI-321563',
				'DriverData' => 'C:\Windows\System32\Drivers\DriverData',
				'POWERLINE_COMMAND' => 'oh-my-posh',
				'POSH_SHELL_VERSION' => '5.1.26100.7705',
				'EFC_12656_1592913036' => '1',
				'COLORTERM' => 'truecolor',
				'SESSIONNAME' => 'Console',
				'IGCCSVC_DB' => '',
				'USERDOMAIN' => 'MPAC',
				'CommonProgramFiles(x86)' => 'C:\Program Files (x86)\Common Files',
				'TERM_PROGRAM' => 'zed',
				'TEMP' => 'C:\Users\asouza\AppData\Local\Temp',
				'POSH_SHELL' => 'pwsh',
				'PNPM_HOME' => 'C:\Users\asouza\AppData\Local\pnpm',
				'ZES_ENABLE_SYSMAN' => '1',
				'HOMEPATH' => '\Users\asouza',
				'OneDrive' => 'C:\Users\asouza\OneDrive',
				'WSLENV' => 'TERM:COLORTERM:TERM_PROGRAM:TERM_PROGRAM_VERSION',
				'USERDNSDOMAIN' => 'MPAC.LOCAL',
				...
				'MAIN_PHP_PATH' => 'C:\laragon\bin\php\php-8.4.2-Win32-vs17-x64\php.exe',
				'USERDOMAIN_ROAMINGPROFILE' => 'MPAC',
				'OS' => 'Windows_NT',
				...
				'EFC_12656_1262719628' => '1',
				'ProgramFiles' => 'C:\Program Files',
				'POSH_THEMES_PATH' => 'C:\Users\asouza\AppData\Local\Programs\oh-my-posh\themes',
				'WEZTERM_CONFIG_DIR' => 'C:\Users\asouza',
				'WEZTERM_CONFIG_FILE' => 'C:\Users\asouza\.wezterm.lua',
				'USERPROFILE' => 'C:\Users\asouza',
				'FPS_BROWSER_USER_PROFILE_STRING' => 'Default',
				'TERM_PROGRAM_VERSION' => '1.12.0+stable.328.f96212f2c50f54d93712fa130d6226b1ce7d76b5',
				'POWERSHELL_TELEMETRY_OPTOUT' => '1',
				'APPDATA' => 'C:\Users\asouza\AppData\Roaming',
			],
		];
	}
