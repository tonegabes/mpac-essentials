...
class Container_8421e92288 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_8421e92288 $container)
			{
	...
	{
		return new PestStan\Type\Pest\PestFileDiscoverer(['E:\codes\mpac-essentials\src'], 'E:\codes\mpac-essentials');
	}
	...
	public function createServiceContainer(): Container_8421e92288
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 10,
			'paths' => ['E:\codes\mpac-essentials\src'],
			'exceptions' => [
				'implicitThrows' => true,
