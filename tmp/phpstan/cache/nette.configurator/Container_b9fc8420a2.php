...
class Container_b9fc8420a2 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_b9fc8420a2 $container)
			{
	...
	public function createService0969(): PestStan\Type\Pest\PestFileDiscoverer
	{
		return new PestStan\Type\Pest\PestFileDiscoverer(
			['E:\codes\mpac-essentials\src', 'E:\codes\mpac-essentials\config'],
			'E:\codes\mpac-essentials'
		);
	}
	...
	public function createServiceContainer(): Container_b9fc8420a2
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 10,
			'paths' => ['E:\codes\mpac-essentials\src', 'E:\codes\mpac-essentials\config'],
			'exceptions' => [
				'implicitThrows' => true,
